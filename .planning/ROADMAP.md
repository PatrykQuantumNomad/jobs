...
Plans:
- [x] 23-01-PLAN.md — GitHub Actions deploy workflow, CI path isolation, sitemap integration, and JSON-LD structured data
- [x] 23-02-PLAN.md — Dark mode infrastructure and dark: utility classes on all section components
- [x] 23-03-PLAN.md — Deployment verification: enable Pages, push, and verify production site
